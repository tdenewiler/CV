...
\begin{itemize}
  \item Low-cost autonomy for large ground vehicles with passive capabilities.
  ...
  \item Setup and manage Continuous Integration Environment for program with > 50 developers from more than 10
...
\begin{tightitemize}%
 \item Wrote custom networking software for autonomous underwater vehicle to compete in AUVSI UUV student
       competition.
