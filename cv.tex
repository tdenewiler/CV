...
\cvcomputer{Languages}{C, C++, Python, Shell/Bash, GNU Make}
           {Tools}{CMake, Doxygen, Jira, Stash, GitHub, GitLab, Jenkins, vim, static analysis}
\cvcomputer{Operating Systems}{GNU/Linux (Debian, Ubuntu, Mint), MacOS X, Windows}
           {Robotics Frameworks}{Robot Operating System}
...
\begin{itemize}
  \item Program with 150-300 foot vessels.
        Our team worked with simulators.
  ...
  \item Create test methods to characterize system performance.
        Focus was on navigation capabilities.
\end{itemize}}
...
\begin{itemize}
  ...
  \item RPM-based PID throttle controller with switching on pitch angle.
\end{itemize}}
