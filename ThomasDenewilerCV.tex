...
\cvline{Algorithm Development}{Kalman Filters, Vehicle Control}
\cvline{Systems Engineering}{***}

\subsection{Development}
\cvcomputer{Languages}{C, C++, Python, Shell/Bash, GNU Make}
           {Tools}{CMake, Doxygen, Trac, Confluence, Jira, Stash, GitHub, Jenkins}
\cvcomputer{Source Management}{SVN, Git, Mercurial}
           {Robotics Frameworks}{Robot Operating System\contributor, Autonomous Capabilities Suite\developer}
...
\begin{itemize}
  \item Worked with ONR Project Officer to develop Autonomy Architecture Reference Model, standard test methods, and Continuous Integration Environment for program with > 50 developers from nearly 10 organizations.
\end{itemize}}
...
\tlcventry{2005}{2009}{Lead Engineer}{SAIC at SPAWAR Pacific}{}{}{
